const defaultSetting: LX.AppSetting = {
  ...
  'player.alarmClock': '07:30',
  'player.alarmClocks': '[]',
  'player.alarmEnable': false,
  'player.alarmClockTimestamp': '',
  'player.alarmRepeat': 'once',
  'player.alarmSource': 'love',
  'player.alarmApplyVolume': false,
  'player.alarmVolume': 0.8,
  'player.alarmAutoStartConfirmed': false,
